...
namespace Rivet {
  ...
  class CMS_2014_I1303894 : public Analysis {
    public:
      ...
      void finalize() {
        ...
        double norm_1jet_histo = inclusive_cross_section*_n_1jet/_n_total;
        double norm_2jet_histo = inclusive_cross_section*_n_2jet/_n_total;
        double norm_3jet_histo = inclusive_cross_section*_n_3jet/_n_total;
        ...
        std::cout<<"Events containing at least 4 jets: "<<_n_4jet<<std::endl;
  ...
  AnalysisBuilder<CMS_2014_I1303894> plugin_CMS_2014_I1303894;
